...
$commentDatabase = new CommentDatabase('Storage/Database.sqlite');

/*$comment = new Comment(
    'Eduards',
    'test comment number dos ',
    'fab8b28a-09eb-42c4-ab1c-7d522fcac738'
);
...
$container->set(
    ...
    new CommentDatabase('Storage/Database.sqlite')
);
